...
function jumpEdit(id) {
    var url="/investigate/edit?id="+id;
...
function add() {
    ...
    $.ajax({
        type:"POST",
        url: "/investigate/uploadAttachment.do",
        data: data,
        ...
        success: function(data){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (user.status ==200){
                        alert(user.msg);
                        window.parent.location.replace("/investigate/list");
                    }else {
